<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="BillApproval.aspx.cs" Inherits="CanteenProject.Admin.BillApproval" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        <br />
        <asp:Button ID="btnViewBill" runat="server" OnClick="Button1_Click" Text="View Bill" />
    </p>
    <p>
        &nbsp;</p>
    <table id="BillForm" class="nav-justified">
        <tr>
            ...
            <td class="modal-sm" style="width: 189px; height: 70px">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="modal-sm" style="width: 189px; height: 61px">
                &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="modal-sm" style="width: 189px; height: 59px">
                &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="modal-sm" style="width: 189px; height: 95px">
                &nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="modal-sm" style="width: 189px; height: 89px">
                &nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td class="modal-sm" style="width: 189px; height: 55px"></td>
            <td style="height: 55px"></td>
        </tr>
        <tr>
            <td style="width: 213px; height: 10px"></td>
            <td style="width: 215px; height: 10px"></td>
            <td class="modal-sm" style="width: 189px; height: 10px"></td>
            <td style="height: 10px"></td>
        </tr>
        <tr>
            <td style="height: 16px; width: 213px"></td>
            <td style="height: 16px; width: 215px"></td>
            <td class="modal-sm" style="width: 189px; height: 16px"></td>
