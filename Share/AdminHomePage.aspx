<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdminHomePage.aspx.cs" Inherits="CanteenProject.Admin.AdminHomePage" %>
    ...
    <table class="nav-justified">
        <tr>
            ...
            <td style="height: 57px">
                <asp:Button ID="btnLocation" runat="server" Text="View" />
            </td>
        </tr>
        <tr>
            ...
            <td style="height: 59px">
                <asp:Button ID="btnCanteen" runat="server" Text="View" />
            </td>
        </tr>
        <tr>
            ...
            <td style="height: 73px">
                <asp:Button ID="btnItemsRates" runat="server" Text="View" />
            </td>
        </tr>
        <tr>
            ...
            <td style="height: 63px">
                <asp:Button ID="btnEmail" runat="server" Text="View" />
            </td>
        </tr>
    </table>
</p>
